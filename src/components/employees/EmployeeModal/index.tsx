...
export const EmployeeModal = ({ isOpen, onClose, onEmployeeAdded }: EmployeeModalProps) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-6">
              <div>
                <label htmlFor="availability.hoursPerWeek" className="block text-sm font-medium text-gray-900">
                  Hours per Week
                </label>
                <input
                  type="number"
              ...
              <div>
                <label htmlFor="availability.shiftPreference" className="block text-sm font-medium text-gray-900">
                  Shift Preference
                </label>
                <select
              ...
              <div>
                <label htmlFor="availability.vacationDaysRemaining" className="block text-sm font-medium text-gray-900">
